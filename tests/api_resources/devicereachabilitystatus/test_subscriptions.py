...
class TestSubscriptions:
    ...
    def test_method_create(self, client: Camara) -> None:
        subscription = client.devicereachabilitystatus.subscriptions.create(
            config={"subscription_detail": {}},
            protocol="HTTP",
            sink="https://endpoint.example.com/sink",
            types=["org.camaraproject.device-reachability-status-subscriptions.v0.reachability-data"],
        )
        assert_matches_type(DeviceReachabilityStatusSubscription, subscription, path=["response"])
    ...
    def test_raw_response_create(self, client: Camara) -> None:
        response = client.devicereachabilitystatus.subscriptions.with_raw_response.create(
            config={"subscription_detail": {}},
            protocol="HTTP",
            sink="https://endpoint.example.com/sink",
            types=["org.camaraproject.device-reachability-status-subscriptions.v0.reachability-data"],
    ...
    def test_streaming_response_create(self, client: Camara) -> None:
        with client.devicereachabilitystatus.subscriptions.with_streaming_response.create(
            config={"subscription_detail": {}},
            protocol="HTTP",
            sink="https://endpoint.example.com/sink",
            types=["org.camaraproject.device-reachability-status-subscriptions.v0.reachability-data"],
    ...
    def test_method_retrieve(self, client: Camara) -> None:
        subscription = client.devicereachabilitystatus.subscriptions.retrieve(
    ...
    def test_raw_response_retrieve(self, client: Camara) -> None:
        response = client.devicereachabilitystatus.subscriptions.with_raw_response.retrieve(
            subscription_id="qs15-h556-rt89-1298",
        )
    ...
    def test_streaming_response_retrieve(self, client: Camara) -> None:
        with client.devicereachabilitystatus.subscriptions.with_streaming_response.retrieve(
            subscription_id="qs15-h556-rt89-1298",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: Camara) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `subscription_id` but received ''"):
            client.devicereachabilitystatus.subscriptions.with_raw_response.retrieve(
                subscription_id="",
            )
    ...
    def test_method_list(self, client: Camara) -> None:
        subscription = client.devicereachabilitystatus.subscriptions.list()
    ...
    def test_raw_response_list(self, client: Camara) -> None:
        response = client.devicereachabilitystatus.subscriptions.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Camara) -> None:
        with client.devicereachabilitystatus.subscriptions.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_delete(self, client: Camara) -> None:
        response = client.devicereachabilitystatus.subscriptions.with_raw_response.delete(
            subscription_id="qs15-h556-rt89-1298",
        )
    ...
    def test_streaming_response_delete(self, client: Camara) -> None:
        with client.devicereachabilitystatus.subscriptions.with_streaming_response.delete(
            subscription_id="qs15-h556-rt89-1298",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: Camara) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `subscription_id` but received ''"):
            client.devicereachabilitystatus.subscriptions.with_raw_response.delete(
                subscription_id="",
            )
...
class TestAsyncSubscriptions:
    ...
    async def test_method_create(self, async_client: AsyncCamara) -> None:
        subscription = await async_client.devicereachabilitystatus.subscriptions.create(
            config={"subscription_detail": {}},
            protocol="HTTP",
            sink="https://endpoint.example.com/sink",
            types=["org.camaraproject.device-reachability-status-subscriptions.v0.reachability-data"],
    ...
    async def test_raw_response_create(self, async_client: AsyncCamara) -> None:
        response = await async_client.devicereachabilitystatus.subscriptions.with_raw_response.create(
            config={"subscription_detail": {}},
            protocol="HTTP",
            sink="https://endpoint.example.com/sink",
            types=["org.camaraproject.device-reachability-status-subscriptions.v0.reachability-data"],
    ...
    async def test_streaming_response_create(self, async_client: AsyncCamara) -> None:
        async with async_client.devicereachabilitystatus.subscriptions.with_streaming_response.create(
            config={"subscription_detail": {}},
            protocol="HTTP",
            sink="https://endpoint.example.com/sink",
            types=["org.camaraproject.device-reachability-status-subscriptions.v0.reachability-data"],
    ...
    async def test_method_retrieve(self, async_client: AsyncCamara) -> None:
        subscription = await async_client.devicereachabilitystatus.subscriptions.retrieve(
            subscription_id="qs15-h556-rt89-1298",
        )
        assert_matches_type(DeviceReachabilityStatusSubscription, subscription, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncCamara) -> None:
        response = await async_client.devicereachabilitystatus.subscriptions.with_raw_response.retrieve(
            subscription_id="qs15-h556-rt89-1298",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncCamara) -> None:
        async with async_client.devicereachabilitystatus.subscriptions.with_streaming_response.retrieve(
            subscription_id="qs15-h556-rt89-1298",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncCamara) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `subscription_id` but received ''"):
            await async_client.devicereachabilitystatus.subscriptions.with_raw_response.retrieve(
                subscription_id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncCamara) -> None:
        subscription = await async_client.devicereachabilitystatus.subscriptions.list()
        assert_matches_type(SubscriptionListResponse, subscription, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncCamara) -> None:
        response = await async_client.devicereachabilitystatus.subscriptions.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncCamara) -> None:
        async with async_client.devicereachabilitystatus.subscriptions.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncCamara) -> None:
        subscription = await async_client.devicereachabilitystatus.subscriptions.delete(
            subscription_id="qs15-h556-rt89-1298",
        )
        assert_matches_type(SubscriptionDeleteResponse, subscription, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncCamara) -> None:
        response = await async_client.devicereachabilitystatus.subscriptions.with_raw_response.delete(
            subscription_id="qs15-h556-rt89-1298",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncCamara) -> None:
        async with async_client.devicereachabilitystatus.subscriptions.with_streaming_response.delete(
            subscription_id="qs15-h556-rt89-1298",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncCamara) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `subscription_id` but received ''"):
            await async_client.devicereachabilitystatus.subscriptions.with_raw_response.delete(
                subscription_id="",
            )
