...
class TestPopulationdensitydata:
    ...
    def test_method_retrieve(self, client: Camara) -> None:
        populationdensitydata = client.populationdensitydata.retrieve(
            ...
            end_time=parse_datetime("2024-04-23T14:44:18.165Z"),
            start_time=parse_datetime("2024-04-23T14:44:18.165Z"),
        )
        assert_matches_type(PopulationdensitydataRetrieveResponse, populationdensitydata, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: Camara) -> None:
        response = client.populationdensitydata.with_raw_response.retrieve(
            area={"area_type": "POLYGON"},
            end_time=parse_datetime("2024-04-23T14:44:18.165Z"),
            start_time=parse_datetime("2024-04-23T14:44:18.165Z"),
        )
        ...
        populationdensitydata = response.parse()
        assert_matches_type(PopulationdensitydataRetrieveResponse, populationdensitydata, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_retrieve(self, client: Camara) -> None:
        with client.populationdensitydata.with_streaming_response.retrieve(
            area={"area_type": "POLYGON"},
            end_time=parse_datetime("2024-04-23T14:44:18.165Z"),
            start_time=parse_datetime("2024-04-23T14:44:18.165Z"),
        ) as response:
...
class TestAsyncPopulationdensitydata:
    ...
    async def test_method_retrieve(self, async_client: AsyncCamara) -> None:
        populationdensitydata = await async_client.populationdensitydata.retrieve(
            area={"area_type": "POLYGON"},
            end_time=parse_datetime("2024-04-23T14:44:18.165Z"),
            start_time=parse_datetime("2024-04-23T14:44:18.165Z"),
        )
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncCamara) -> None:
        response = await async_client.populationdensitydata.with_raw_response.retrieve(
            area={"area_type": "POLYGON"},
            end_time=parse_datetime("2024-04-23T14:44:18.165Z"),
            start_time=parse_datetime("2024-04-23T14:44:18.165Z"),
        )
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        populationdensitydata = await response.parse()
        assert_matches_type(PopulationdensitydataRetrieveResponse, populationdensitydata, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncCamara) -> None:
        async with async_client.populationdensitydata.with_streaming_response.retrieve(
            area={"area_type": "POLYGON"},
            end_time=parse_datetime("2024-04-23T14:44:18.165Z"),
            start_time=parse_datetime("2024-04-23T14:44:18.165Z"),
        ) as response:
