...
class TestSubscriptions:
    ...
    def test_method_create(self, client: Camara) -> None:
        subscription = client.simswap.subscriptions.create(
            config={"subscription_detail": {}},
            protocol="HTTP",
            sink="https://endpoint.example.com/sink",
            types=["org.camaraproject.sim-swap-subscriptions.v0.swapped"],
        )
        assert_matches_type(SimSwapSubscription, subscription, path=["response"])
    ...
    def test_method_create_with_all_params(self, client: Camara) -> None:
        subscription = client.simswap.subscriptions.create(
            config={
                "subscription_detail": {"phone_number": "+123456789"},
                "subscription_expire_time": parse_datetime("2025-01-17T13:18:23.682Z"),
    ...
    def test_raw_response_create(self, client: Camara) -> None:
        response = client.simswap.subscriptions.with_raw_response.create(
            config={"subscription_detail": {}},
            protocol="HTTP",
            sink="https://endpoint.example.com/sink",
            types=["org.camaraproject.sim-swap-subscriptions.v0.swapped"],
    ...
    def test_streaming_response_create(self, client: Camara) -> None:
        with client.simswap.subscriptions.with_streaming_response.create(
            config={"subscription_detail": {}},
            protocol="HTTP",
            sink="https://endpoint.example.com/sink",
            types=["org.camaraproject.sim-swap-subscriptions.v0.swapped"],
    ...
    def test_method_retrieve(self, client: Camara) -> None:
        subscription = client.simswap.subscriptions.retrieve(
    ...
    def test_raw_response_retrieve(self, client: Camara) -> None:
        response = client.simswap.subscriptions.with_raw_response.retrieve(
            subscription_id="qs15-h556-rt89-1298",
        )
    ...
    def test_streaming_response_retrieve(self, client: Camara) -> None:
        with client.simswap.subscriptions.with_streaming_response.retrieve(
            subscription_id="qs15-h556-rt89-1298",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: Camara) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `subscription_id` but received ''"):
            client.simswap.subscriptions.with_raw_response.retrieve(
                subscription_id="",
            )
    ...
    def test_method_list(self, client: Camara) -> None:
        subscription = client.simswap.subscriptions.list()
    ...
    def test_raw_response_list(self, client: Camara) -> None:
        response = client.simswap.subscriptions.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Camara) -> None:
        with client.simswap.subscriptions.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_delete(self, client: Camara) -> None:
        response = client.simswap.subscriptions.with_raw_response.delete(
            subscription_id="qs15-h556-rt89-1298",
        )
    ...
    def test_streaming_response_delete(self, client: Camara) -> None:
        with client.simswap.subscriptions.with_streaming_response.delete(
            subscription_id="qs15-h556-rt89-1298",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: Camara) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `subscription_id` but received ''"):
            client.simswap.subscriptions.with_raw_response.delete(
                subscription_id="",
            )
...
class TestAsyncSubscriptions:
    ...
    async def test_method_create(self, async_client: AsyncCamara) -> None:
        subscription = await async_client.simswap.subscriptions.create(
            config={"subscription_detail": {}},
            protocol="HTTP",
            sink="https://endpoint.example.com/sink",
            types=["org.camaraproject.sim-swap-subscriptions.v0.swapped"],
    ...
    async def test_raw_response_create(self, async_client: AsyncCamara) -> None:
        response = await async_client.simswap.subscriptions.with_raw_response.create(
            config={"subscription_detail": {}},
            protocol="HTTP",
            sink="https://endpoint.example.com/sink",
            types=["org.camaraproject.sim-swap-subscriptions.v0.swapped"],
    ...
    async def test_streaming_response_create(self, async_client: AsyncCamara) -> None:
        async with async_client.simswap.subscriptions.with_streaming_response.create(
            config={"subscription_detail": {}},
            protocol="HTTP",
            sink="https://endpoint.example.com/sink",
            types=["org.camaraproject.sim-swap-subscriptions.v0.swapped"],
    ...
    async def test_method_retrieve(self, async_client: AsyncCamara) -> None:
        subscription = await async_client.simswap.subscriptions.retrieve(
            subscription_id="qs15-h556-rt89-1298",
        )
        assert_matches_type(SimSwapSubscription, subscription, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncCamara) -> None:
        response = await async_client.simswap.subscriptions.with_raw_response.retrieve(
            subscription_id="qs15-h556-rt89-1298",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncCamara) -> None:
        async with async_client.simswap.subscriptions.with_streaming_response.retrieve(
            subscription_id="qs15-h556-rt89-1298",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncCamara) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `subscription_id` but received ''"):
            await async_client.simswap.subscriptions.with_raw_response.retrieve(
                subscription_id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncCamara) -> None:
        subscription = await async_client.simswap.subscriptions.list()
        assert_matches_type(SubscriptionListResponse, subscription, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncCamara) -> None:
        response = await async_client.simswap.subscriptions.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncCamara) -> None:
        async with async_client.simswap.subscriptions.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncCamara) -> None:
        subscription = await async_client.simswap.subscriptions.delete(
            subscription_id="qs15-h556-rt89-1298",
        )
        assert_matches_type(SubscriptionDeleteResponse, subscription, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncCamara) -> None:
        response = await async_client.simswap.subscriptions.with_raw_response.delete(
            subscription_id="qs15-h556-rt89-1298",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncCamara) -> None:
        async with async_client.simswap.subscriptions.with_streaming_response.delete(
            subscription_id="qs15-h556-rt89-1298",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncCamara) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `subscription_id` but received ''"):
            await async_client.simswap.subscriptions.with_raw_response.delete(
                subscription_id="",
            )
