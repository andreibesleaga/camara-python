...
from ...types.devicereachabilitystatus import (
    DeviceReachabilityStatusProtocol,
    subscription_create_params,
)
from ...types.devicereachabilitystatus.subscription_list_response import SubscriptionListResponse
from ...types.devicereachabilitystatus.subscription_delete_response import SubscriptionDeleteResponse
from ...types.devicereachabilitystatus.device_reachability_status_protocol import DeviceReachabilityStatusProtocol
from ...types.devicereachabilitystatus.device_reachability_status_config_param import (
    DeviceReachabilityStatusConfigParam,
)
from ...types.devicereachabilitystatus.device_reachability_status_subscription import (
    DeviceReachabilityStatusSubscription,
)
from ...types.devicereachabilitystatus.device_reachability_status_subscription_event_type import (
...
class SubscriptionsResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        config: DeviceReachabilityStatusConfigParam,
        protocol: DeviceReachabilityStatusProtocol,
        sink: str,
        types: List[DeviceReachabilityStatusSubscriptionEventType],
        ...
        return self._post(
            ...
            cast_to=DeviceReachabilityStatusSubscription,
        )
    ...
    def retrieve(
        ...
        *,
        ...
        extra_headers = {**strip_not_given({"x-correlator": x_correlator}), **(extra_headers or {})}
        return self._get(
            path_template("/devicereachabilitystatus/subscriptions/{subscription_id}", subscription_id=subscription_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=DeviceReachabilityStatusSubscription,
