...
from ...types.connectednetworktype import (
    ConnectedNetworkTypeProtocol,
    subscription_create_params,
)
from ...types.connectednetworktype.subscription_list_response import SubscriptionListResponse
from ...types.connectednetworktype.subscription_delete_response import SubscriptionDeleteResponse
from ...types.connectednetworktype.connected_network_type_protocol import ConnectedNetworkTypeProtocol
from ...types.connectednetworktype.connected_network_type_config_param import ConnectedNetworkTypeConfigParam
from ...types.connectednetworktype.connected_network_type_subscription import ConnectedNetworkTypeSubscription
from ...types.connectednetworktype.connected_network_type_subscription_event_type import (
...
class SubscriptionsResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        config: ConnectedNetworkTypeConfigParam,
        ...
        Args:
          ...
          types: Camara Event types eligible to be delivered by this subscription. Note: As of
        ...
        return self._post(
            ...
            cast_to=ConnectedNetworkTypeSubscription,
        )
    ...
    def retrieve(
        ...
        *,
        ...
        extra_headers = {**strip_not_given({"x-correlator": x_correlator}), **(extra_headers or {})}
        return self._get(
            path_template("/connectednetworktype/subscriptions/{subscription_id}", subscription_id=subscription_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ConnectedNetworkTypeSubscription,
