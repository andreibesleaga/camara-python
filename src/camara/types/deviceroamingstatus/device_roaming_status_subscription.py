...
from .device_roaming_status_config import DeviceRoamingStatusConfig
...
__all__ = ["DeviceRoamingStatusSubscription"]


class DeviceRoamingStatusSubscription(BaseModel):
