...
__all__ = ["DeviceLocationDevice", "Ipv4Address"]
...
class DeviceLocationDevice(BaseModel):
    ...
    * `networkAccessIdentifier`
    ...
    ipv4_address: Optional[Ipv4Address] = FieldInfo(alias="ipv4Address", default=None)
    """
